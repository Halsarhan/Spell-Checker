...
//This is part 2 of HW 7
import java.io.*;
import java.util.LinkedList;
import java.util.Scanner;

public class SortedSpellChecker {
	...
	public static HashBucket sortingMisspelled;
	...
	public static void readFile() throws IOException{
		...
		sortingMisspelled = new HashBucket();
		...
		while (choice != 'q'){
			if (choice != 'f'){
							...
							if(!Repeated.contains(word)){
								if (!Dictionary.contains(word)){
									...
									if(choice2 == 'i'){
										...
										sortingMisspelled.hash(word+" "+lineNumber);
					...
					//print sorted misspelled words to output .txt file
					out=new BufferedWriter(new FileWriter(new File("sortedMisspelled.txt")));
					sortingMisspelled.sorting();
					String printThis = sortingMisspelled.sorting();
					out.write(printThis);
					out.close();
